...
class WalletForm extends React.Component {
  ...
  myCurrencies(WalletMasterData) {
    ...
    WalletMasterData.forEach(function(value,index) {
      ...
      var currencyObject = mythis.ApiCoinford.getCurrencyObject(WalletMaster.CurrencyId);
      var titleName = currencyObject.Name + '( ' + currencyObject.Code + ' )';
      panes.push({ title: currencyObject.Code,
        content: <WalletList
